...
GROUP BY fv.case_id ,fv.case_category_id ,fv.case_category_level ,cpl.work_code_id ,cpl.status_id ,cpl.actor_id ,cpl.price_list_id ,cpl.price_large_entity_flag ,cpl.currency_id ,cpl.designated_state_id ,cpl.PRICE_CHARGEABLE;
