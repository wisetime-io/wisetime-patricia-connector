...
class PatriciaConnectorIntegrationTest {
  ...
  void testFailedTimeGroup() {
    ...
    group.callerKey("Fehl8Szeterst")
        ...
        .tags(ImmutableList.of(new Tag().name("TM1018DE00").path("Patricia").description("WATERSAFE PROTECTIVE CREAM")))
    ...
    assertThat(connector.postTime(null, group)).isEqualTo(PostResult.SUCCESS);
  }
}
